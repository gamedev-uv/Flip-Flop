...
-- \   \   \/     Version : 8.1i
--  \   \         Application : ISE
--  /   /         Filename : fullSubtractorSimplifiedWave.vhw
-- /___/   /\     Timestamp : Sat Jul 25 19:02:33 2026
-- \   \  /  \ 
--  \___\/\___\ 
--
--Command: 
--Design Name: fullSubtractorSimplifiedWave
--Device: Xilinx
--
...
ENTITY fullSubtractorSimplifiedWave IS
END fullSubtractorSimplifiedWave;

ARCHITECTURE testbench_arch OF fullSubtractorSimplifiedWave IS
    FILE RESULTS: TEXT OPEN WRITE_MODE IS "results.txt";

    COMPONENT fulllSubtractorSimplified
        PORT (
            A : In std_logic;
            B : In std_logic;
            C : In std_logic;
