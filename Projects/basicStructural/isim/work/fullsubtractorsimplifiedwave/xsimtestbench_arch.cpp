#include "isim/work/fullsubtractorsimplifiedwave/testbench_arch.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        topvh = new Work_fullsubtractorsimplifiedwave_testbench_arch("fullSubtractorSimplifiedWave");
