#include "isim/work/fullsubtractorcomponentswave/testbench_arch.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        topvh = new Work_fullsubtractorcomponentswave_testbench_arch("fullSubtractorComponentsWave");
