...
-- \   \   \/     Version : 8.1i
--  \   \         Application : ISE
--  /   /         Filename : fullSubtractorComponentsWave.vhw
-- /___/   /\     Timestamp : Sat Jul 25 19:02:56 2026
-- \   \  /  \ 
--  \___\/\___\ 
--
--Command: 
--Design Name: fullSubtractorComponentsWave
--Device: Xilinx
--
...
ENTITY fullSubtractorComponentsWave IS
END fullSubtractorComponentsWave;

ARCHITECTURE testbench_arch OF fullSubtractorComponentsWave IS
    FILE RESULTS: TEXT OPEN WRITE_MODE IS "results.txt";

    COMPONENT fullSubtractorComponents
        PORT (
            A : In std_logic;
            B : In std_logic;
            C : In std_logic;
