...
-- \   \   \/     Version : 8.1i
--  \   \         Application : ISE
--  /   /         Filename : fullAdderSimplifiedWave.vhw
-- /___/   /\     Timestamp : Thu Jul 16 22:52:44 2026
-- \   \  /  \ 
--  \___\/\___\ 
--
--Command: 
--Design Name: fullAdderSimplifiedWave
--Device: Xilinx
--
...
ENTITY fullAdderSimplifiedWave IS
END fullAdderSimplifiedWave;

ARCHITECTURE testbench_arch OF fullAdderSimplifiedWave IS
    FILE RESULTS: TEXT OPEN WRITE_MODE IS "results.txt";

    COMPONENT fullAdderSimplified
        PORT (
            A : In std_logic;
            B : In std_logic;
            C : In std_logic;
